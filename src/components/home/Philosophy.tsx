        ...
        <div className="grid grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="heading-editorial mb-10 leading-[1.2]">
              <span className="text-muted-foreground">{t('founder.quote')}</span>
            </h2>
            ...
            <div className="border-t border-border pt-6">
              <p className="font-serif text-lg text-accent italic">{t('founderLetter.signature')}</p>
              <p className="text-xs text-muted-foreground mt-1 tracking-[0.2em] uppercase">
                {t('founderLetter.role')}
              </p>
            </div>
            ...
            <motion.div
              ...
              className="text-accent/20 font-serif text-[120px] leading-none -mt-4"
            >
              &ldquo;
            </motion.div>
          </motion.div>
            ...
            >
              <div className="image-editorial aspect-[4/5] overflow-hidden">
                <img
                  ...
                  alt="Digital nomad working with ocean view"
                  loading="lazy"
                  decoding="async"
                ...
                >
                  <p className="caption-editorial text-accent mb-2">Koh Phangan, Thailand</p>
                  <p className="text-sm text-muted-foreground">
                    Next-generation work & life experience
                  </p>
                </motion.div>
              </div>
            </motion.div>
