    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <video
          ...
          poster="https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?q=80&w=2039&auto=format&fit=crop"
        >
          <source
      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 text-center">
        ...
        >
          ...
          <motion.p
            ...
            className="font-serif text-2xl md:text-3xl lg:text-4xl text-background/90 mb-6 italic"
          >
            {t('hero.subtitle')}
          </motion.p>
