...
const processSteps = [
  {
    step: 1,
    title: "Strategic Eligibility Analysis",
    desc: "We assess your profile, travel history, and objectives to determine the optimal DTV pathway.",
  },
  {
    step: 2,
    title: "Document Preparation & Audit",
    desc: "Complete document assembly with accuracy verification before submission.",
  },
  {
    step: 3,
    title: "Submission & Post-Approval Setup",
    desc: "We handle submission logistics and guide you through entry protocols.",
  },
];

const faqs = [
  {
    q: "What is the Thailand DTV Visa?",
    a: "The Destination Thailand Visa (DTV) is a 5-year multi-entry visa offering 180-day stays per entry with unlimited re-entries. Designed for digital nomads, remote workers, and long-term visitors.",
  },
  {
    q: "Who is eligible for the DTV?",
    a: "Remote workers, freelancers, entrepreneurs, and individuals who can demonstrate a legitimate purpose of stay such as work, education, or cultural activities.",
  },
  {
    q: "How long does the process take?",
    a: "Typical processing is 15-30 business days depending on the consulate and completeness of documentation.",
  },
  {
    q: "Can I work remotely on the DTV?",
    a: "Yes. The DTV explicitly permits remote work for foreign employers or your own business registered outside Thailand.",
  },
  {
    q: "What happens if my application is rejected?",
    a: "Our strategic advisory packages include pre-submission audits to minimize rejection risk. If rejected, we provide a revised submission strategy.",
  },
  {
    q: "Can my family join me?",
    a: "Yes. Dependents can apply for their own DTV visas. We handle family applications as a coordinated package.",
  },
];
      ...
      <section className="py-20 bg-card border-t border-border">
        <div className="container max-w-2xl px-6">
          ...
          <p className="text-muted-foreground text-center mb-10 body-editorial">
            Quick preliminary assessment. Then purchase your advisory package above.
          </p>
          {formSubmitted ? (
            <div className="text-center py-10 space-y-6">
              <p className="text-lg font-heading text-foreground">
                Your eligibility looks strong. Purchase an advisory package above to get started.
              </p>
              <Button
                onClick={() => document.getElementById("checkout")?.scrollIntoView({ behavior: "smooth" })}
      ...
      <section className="py-20 lg:py-28 bg-foreground text-background grain-overlay">
        <div className="container mx-auto px-6 lg:px-12 text-center max-w-2xl">
          ...
          <p className="body-editorial text-background/70 mb-8">
            Your visa is the key. Our relocation program is the door.
          </p>
          <Link
