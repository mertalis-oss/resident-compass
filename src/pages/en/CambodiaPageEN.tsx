...
const context = [
  { icon: Zap, title: 'Fast Setup', desc: 'Business registration and banking in days, not months. Cambodia\'s regulatory environment favors speed.' },
  { icon: Shield, title: 'Calm Operations', desc: 'Low cost of living, minimal bureaucracy, and a welcoming environment for international entrepreneurs.' },
  { icon: Globe, title: 'Strategic Position', desc: 'Gateway between Thailand, Vietnam, and Laos. Growing digital infrastructure and ASEAN integration.' },
];

const pathways = [
  { icon: Building2, title: 'Phnom Penh Base', desc: 'Establish your business headquarters in Cambodia\'s dynamic capital. Banking, co-working, and community.' },
  { icon: Users, title: 'Siem Reap Retreat', desc: 'Cultural immersion and remote work from the gateway to Angkor. Ideal for creative and wellness professionals.' },
  { icon: Briefcase, title: 'Business Formation', desc: 'Company registration, work permits, and tax-efficient structuring for digital businesses.' },
];

export default function CambodiaPageEN() {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const whatsappUrl = buildWhatsAppUrl('Page: Cambodia | Intent: cambodia-advisory | Domain: ' + (typeof window !== 'undefined' ? window.location.hostname : ''));
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="Cambodia — Fast. Calm. Flexible. | Plan B Asia" description="Concierge arrival and strategic positioning in Cambodia." canonical="https://planbasia.com/destinations/cambodia" schemaType="Service" serviceName="Cambodia Advisory" />
      <FocusedNavbar />
      <TrustBar />
      ...
      <section className="relative min-h-[85vh] flex items-center grain-overlay">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1569154941061-e231b4725ef1?q=80&w=2070&auto=format&fit=crop')` }} />
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-12 py-32">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-3xl">
            ...
            <h1 className="heading-display text-background mb-6">Fast. Calm. Flexible.<span className="block text-accent">Cambodia.</span></h1>
