...
export const MagicLinkEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your private access link to {siteName}</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={card}>
          ...
          <Text style={text}>
            Sign in to {siteName} using the secure link below. For your
            protection, this link expires shortly.
          </Text>
          ...
          <Text style={footer}>
            If you did not request access, you may safely disregard this message.
          </Text>
        </Section>
      </Container>
    </Body>
